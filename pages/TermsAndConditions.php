...
<body style="background:#f4f6f9">
    <div class="container" style="background:#f4f6f9">
        <div class="col offset-md-1" style="margin:2% auto">
        <p>
            <div class="text-center"><h2 class="display-2"><b>Terms and Conditions</h2></b></div>
            Last updated: July 20, 2021<br><br>
            Please read these terms and conditions carefully before using Our Service.<br>
            <h3 class="display-4"><b>CAN-SPAM ACT</b></h3>
            The CAN-SPAM Act, a law that sets the rules for commercial email, establishes requirements for commercial messages, gives recipients the right to have you stop emailing them, and spells out tough penalties for violations.<br><br>
            Despite its name, the CAN-SPAM Act doesn’t apply just to bulk email. It covers all commercial messages, which the law defines as “any electronic mail message the primary purpose of which is the commercial advertisement or promotion of a commercial product or service,” including email that promotes content on commercial websites. The law makes no exception for business-to-business email. That means all email – for example, a message to former customers announcing a new product line – must comply with the law.<br><br>
            Each separate email in violation of the CAN-SPAM Act is subject to penalties of up to $43,792, so non-compliance can be costly. But following the law isn’t complicated. Here’s a rundown of CAN-SPAM’s main requirements:<br>
            <ol style="margin:1%" type="1">
                <li><b>Don’t use false or misleading header information.</b> Your “From,” “To,” “Reply-To,” and routing information – including the originating domain name and email address – must be accurate and identify the person or business who initiated the message.</li>
                <li><b>Don’t use deceptive subject lines.</b> The subject line must accurately reflect the content of the message.</li>
                <li><b>Identify the message as an ad.</b> The law gives you a lot of leeway in how to do this, but you must disclose clearly and conspicuously that your message is an advertisement.</li>
                <li><b>Tell recipients where you’re located.</b> Your message must include your valid physical postal address. This can be your current street address, a post office box you’ve registered with the U.S. Postal Service, or a private mailbox you’ve registered with a commercial mail receiving agency established under Postal Service regulations.</li>
                <li><b>Tell recipients how to opt out of receiving future email from you.</b> Your message must include a clear and conspicuous explanation of how the recipient can opt out of getting email from you in the future. Craft the notice in a way that’s easy for an ordinary person to recognize, read, and understand. Creative use of type size, color, and location can improve clarity. Give a return email address or another easy Internet-based way to allow people to communicate their choice to you. You may create a menu to allow a recipient to opt out of certain types of messages, but you must include the option to stop all commercial messages from you. Make sure your spam filter doesn’t block these opt-out requests.</li>
                <li><b>Honor opt-out requests promptly.</b> Any opt-out mechanism you offer must be able to process opt-out requests for at least 30 days after you send your message. You must honor a recipient’s opt-out request within 10 business days. You can’t charge a fee, require the recipient to give you any personally identifying information beyond an email address, or make the recipient take any step other than sending a reply email or visiting a single page on an Internet website as a condition for honoring an opt-out request. Once people have told you they don’t want to receive more messages from you, you can’t sell or transfer their email addresses, even in the form of a mailing list. The only exception is that you may transfer the addresses to a company you’ve hired to help you comply with the CAN-SPAM Act.</li>
                <li><b>Monitor what others are doing on your behalf.</b> The law makes clear that even if you hire another company to handle your email marketing, you can’t contract away your legal responsibility to comply with the law. Both the company whose product is promoted in the message and the company that actually sends the message may be held legally responsible.</li>
            </ol>
            <h3 class="display-4"><b>Interpretation and Definitions</b></h3>
            <h3 class="display-6">Interpretation</h3>
            ...
            <h3 class="display-6">Definitions</h3>
            ...
            <ul style="margin:1%">
                ...
                <li>Country refers to: Hawaii, United States</li>
                <li>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Maui Snorkeling, 360 Ho’ohana Drive Suite #208 Kahului, HI 96732.</li>
                ...
                <li>Website refers to Maui Snorkeling, accessible from https://mauisnorkeling.com/</li>
                <li>You means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
            </ul>
            <h3 class="display-4"><b>Acknowledgment</b></h3>  
            ...
            <h3 class="display-4"><b>Links to Other Websites</b></h3>
            ...
            <h3 class="display-4"><b>Termination</b></h3><br>
            ...
            <h3 class="display-4"><b>Limitation of Liability</b></h3><br>
            ...
            <h3 class="display-4"><b>"AS IS" and "AS AVAILABLE" Disclaimer</b></h3><br>
            ...
            <h3 class="display-4"><b>Governing Law</b></h3><br>
            ...
            <h3 class="display-4"><b>Disputes Resolution</b></h3><br>
            ...
            <h3 class="display-4"><b>For European Union (EU) Users</b></h3><br>
            ...
            <h3 class="display-4"><b>United States Legal Compliance</b></h3><br>
            You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a "terrorist supporting" country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.<br><br>

            <h3 class="display-4"><b>Severability and Waiver</b></h3><br>
            <h3 class="display-5">Severability</h3><br>
            ...
            <h3 class="display-5">Waiver</h3><br>
            ...
            <h3 class="display-4"><b>Translation Interpretation</b></h3><br>
            ...
            <h3 class="display-4"><b>Changes to These Terms and Conditions</b></h3><br>
            We reserve the right, at Our sole discretion, to modify or replace these Terms at any time. If a revision is material We will make reasonable efforts to provide at least 30 days' notice prior to any new terms taking effect. What constitutes a material change will be determined at Our sole discretion.<br><br>
            
            <h3 class="display-4"><b>Contact Us</b></h3><br>
            If you have any questions about these Terms and Conditions, You can contact us:<br>
            <ul style="margin:1%">
                <li>By email: info@mauisnorkeling.com</li>
                <li>By visiting this page on our website: https://mauisnorkeling.com/contacts/</li>
                <li>By phone number: 888-983-8080</li>
                <li>By mail: 360 Ho’ohana Drive Suite #208 Kahului, HI 96732</li>
            </ul>

...
<body>
    <div style="margin:5%;color:black;background-color:#FAFDF3;padding:2.5%">
        <p>
            <h3 class="display-3">Terms and Conditions</h3>
            Last updated: July 20, 2021<br><br>
            Please read these terms and conditions carefully before using Our Service.<br>
            <h3 class="display-3">CAN-SPAM ACT</h3>
            ...
            <h3 class="display-3">Interpretation and Definitions</h3>
            ...
            <h3 class="display-3">Acknowledgment</h3>  
            ...
            <h3 class="display-3">Links to Other Websites</h3>
            ...
            <h3 class="display-3">Termination</h3><br>
            ...
            <h3 class="display-3">Limitation of Liability</h3><br>
            ...
            <h3 class="display-3">"AS IS" and "AS AVAILABLE" Disclaimer</h3><br>
            ...
            <h3 class="display-3">Governing Law</h3><br>
            ...
            <h3 class="display-3">Disputes Resolution</h3><br>
            ...
            <h3 class="display-3">For European Union (EU) Users</h3><br>
            ...
            <h3 class="display-3">United States Legal Compliance</h3><br>
            You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a "terrorist supporting" country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.<br><br>

            <h3 class="display-3">Severability and Waiver</h3><br>
            ...
            <h3 class="display-3">Translation Interpretation</h3><br>
            ...
            <h3 class="display-3">Changes to These Terms and Conditions</h3><br>
